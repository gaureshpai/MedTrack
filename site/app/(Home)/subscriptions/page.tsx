...
import { Bell, CheckCircle, Grid3X3, List, Play, Radio, Calendar } from 'lucide-react';
import { subscriptionVideos, subscribedChannels, type Video, type Channel } from "@/data/draft";
    ...
    <Link href={`/watch/${video.id}`} className="group">
      <div className="flex gap-4 p-4 rounded-lg hover:bg-gray-50 transition-colors">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="font-medium line-clamp-2 group-hover:text-blue-600 transition-colors mb-2">
            {video.title}
          </h3>
